...
### Step 2: Add the Python Helper
Copy [**`modelsight.py`**](modelsight.py) into your project directory. Because it relies entirely on Python's standard library, you do not need to `pip install` anything.
